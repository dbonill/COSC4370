...
int main()
{
    ...
    //glBindBuffer( GL_ELEMENT_ARRAY_BUFFER, UVBO );
    //glGenVertexArrays(1, &containerVAO);
    glGenBuffers(1, &UVBO);
    ...
    // color attribute
    glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, 0* sizeof(float), (GLvoid*)(0* sizeof(float)));
    glEnableVertexAttribArray(1);
    // texture coord attribute
    
    /*
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, 0* sizeof(float), (GLvoid*)(1* sizeof(float)));
...
*/
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
         //glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, texture.width, texture.height, 0, GL_RGB, GL_UNSIGNED_BYTE, texture);
        //glGenerateMipmap(GL_TEXTURE_2D);
        //glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, GL_RGB, GL_UNSIGNED_BYTE, texture);
